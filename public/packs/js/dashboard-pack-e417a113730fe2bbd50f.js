...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/dashboard-pack.js");
/******/ })
/************************************************************************/
/******/ ({
...
/*!*************************************!*\
  !*** ./app/javascript/dashboard.js ***!
  \*************************************/
/*! exports provided: add_garden_modal, update_garden_modal_close, populate_table_garden, add_garden, add_produce_modal, add_produce_modal_close, update_produce_modal_close, populate_table_produce, add_produce */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "add_garden_modal", function() { return add_garden_modal; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "update_garden_modal_close", function() { return update_garden_modal_close; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "populate_table_garden", function() { return populate_table_garden; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "add_garden", function() { return add_garden; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "add_produce_modal", function() { return add_produce_modal; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "add_produce_modal_close", function() { return add_produce_modal_close; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "update_produce_modal_close", function() { return update_produce_modal_close; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "populate_table_produce", function() { return populate_table_produce; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "add_produce", function() { return add_produce; });
/* harmony import */ var _misc__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./misc */ "./app/javascript/misc.js");
...
function post_garden(name, address, lat, _long, contact_name, contact_num, email, image, notes) {
...
function patch_garden(id, name, address, lat, _long2, contact_name, contact_num, email, image, notes) {
  var xhr = new XMLHttpRequest();
  var url = "./gardens/".concat(id);
...
function patch_garden_produce(id, garden_id, produce_id, available, readiness, planted_at) {
  var xhr = new XMLHttpRequest();
  var url = "./garden_produces/".concat(id);
  xhr.open('PATCH', url, true);
  xhr.setRequestHeader('Content-Type', 'application/json');
...
function delete_garden_modal(garden_id) {
  document.getElementById('delete_garden_modal_footer').innerHTML = "\n    <a onclick=\"delete_garden_modal_close()\" class=\"modal-close waves-effect waves-green btn-flat\">\n      Cancel\n    </a>\n    <a onclick=\"delete_garden(".concat(garden_id, ")\" class=\"modal-close waves-effect waves-green btn-flat\">\n      Delete\n    </a>");
  var instance = materialize_css__WEBPACK_IMPORTED_MODULE_1___default.a.Modal.getInstance(document.getElementById('delete_garden_modal'));
  instance.open();
}
...
function add_garden_modal() {
  var instance = materialize_css__WEBPACK_IMPORTED_MODULE_1___default.a.Modal.getInstance(document.getElementById('add_garden_modal'));
  instance.open();
}
...
function update_garden_modal(garden_id) {
  document.getElementById('update_garden_modal_footer').innerHTML = "\n    <a onclick=\"update_garden_modal_close()\" class=\"modal-close waves-effect waves-green btn-flat\">\n      Cancel\n    </a>\n    <a onclick=\"update_garden(".concat(garden_id, ")\" class=\"modal-close waves-effect waves-green btn-flat\">\n      Update\n    </a>");
  var instance = materialize_css__WEBPACK_IMPORTED_MODULE_1___default.a.Modal.getInstance(document.getElementById('update_garden_modal'));
  instance.open();
}
...
function populate_table_garden() {
  Object(_misc__WEBPACK_IMPORTED_MODULE_0__["getJSON"])('./gardens', function (data) {
    for (var i = 0; i <= data.length - 1; i++) {
      document.getElementById('garden_table').innerHTML += "\n        <tr>\n          <td>".concat(data[i].name, "</td>\n          <td>").concat(data[i].address, "</td>\n          <td>").concat(data[i].lat, ", ").concat(data[i]["long"], "</td>\n          <td>").concat(data[i].contact_name, "</td>\n          <td>").concat(data[i].contact_number, "</td>\n          <td>\n            <ul id=garden_id").concat(data[i].id, "></ul>\n          </td>\n          <td>").concat(data[i].notes, "</td>\n          <td>\n            <a onclick='delete_garden_modal(").concat(data[i].id, ")' class=\"waves-effect waves-teal btn-flat\">\n              <i class=\"material-icons\">delete</i>\n            </a>\n            <a onclick='update_garden_modal(").concat(data[i].id, ")' class=\"waves-effect waves-teal btn-flat\">\n              <i class=\"material-icons\">edit</i>\n            </a>\n          </td>\n        </tr>");
      console.log(typeof data[i].contact_name);
    }

    Object(_misc__WEBPACK_IMPORTED_MODULE_0__["getJSON"])('./garden_produces', function (data) {
      for (var _i = 0; _i <= data.length - 1; _i++) {
        document.getElementById("garden_id".concat(data[_i].garden_id)).innerHTML += "\n          <li>\n            <span class=\"produce_id".concat(data[_i].produce_id, "\"></span>,\n            ").concat(data[_i].available_at, "\n          </li>");
      }

      Object(_misc__WEBPACK_IMPORTED_MODULE_0__["getJSON"])('./produces', function (data) {
        for (var _i2 = 0; _i2 <= data.length - 1; _i2++) {
          var elements = document.getElementsByClassName("produce_id".concat(_i2));

          for (var j = 0; j < elements.length; j++) {
            elements[j].innerHTML += data[_i2].name;
          }
        }
      }, function (status) {
...
function add_garden() {
  if (!RegExp('^(?!\\s*$).+').test(document.forms['add_garden']['name'].value)) {
    ...
    post_garden(document.forms['add_garden']['name'].value, document.forms['add_garden']['address'].value, document.forms['add_garden']['lat'].value, document.forms['add_garden']['long'].value, document.forms['add_garden']['contact_name'].value, document.forms['add_garden']['contact_num'].value, document.forms['add_garden']['email'].value, document.forms['add_garden']['image'].value, document.forms['add_garden']['notes'].value);
...
function update_garden(id) {
  if (!RegExp('^(?!\\s*$).+').test(document.forms['update_garden']['name'].value)) {
    ...
    patch_garden(id, document.forms['update_garden']['name'].value, document.forms['update_garden']['address'].value, document.forms['update_garden']['lat'].value, document.forms['update_garden']['long'].value, document.forms['update_garden']['contact_name'].value, document.forms['update_garden']['contact_num'].value, document.forms['update_garden']['email'].value, document.forms['update_garden']['image'].value, document.forms['update_garden']['notes'].value);
    materialize_css__WEBPACK_IMPORTED_MODULE_1___default.a.toast({
      html: 'Garden Updated!'
    });
  }
...
function delete_produce_modal(produce_id) {
  document.getElementById('delete_produce_modal_footer').innerHTML = "\n    <a onclick=\"delete_produce_modal_close()\" class=\"modal-close waves-effect waves-green btn-flat\">\n      Cancel\n    </a>\n    <a onclick=\"delete_produce(".concat(produce_id, ")\" class=\"modal-close waves-effect waves-green btn-flat\">\n      Delete\n    </a>");
  var instance = materialize_css__WEBPACK_IMPORTED_MODULE_1___default.a.Modal.getInstance(document.getElementById('delete_produce_modal'));
  instance.open();
}
...
function add_produce_modal() {
  var instance = materialize_css__WEBPACK_IMPORTED_MODULE_1___default.a.Modal.getInstance(document.getElementById('add_produce_modal'));
  instance.open();
}
...
function update_produce_modal(produce_id) {
  document.getElementById('update_produce_modal_footer').innerHTML = "\n    <a onclick=\"update_produce_modal_close()\" class=\"modal-close waves-effect waves-green btn-flat\">\n      Cancel\n    </a>\n    <a onclick=\"update_produce(".concat(produce_id, ")\" class=\"modal-close waves-effect waves-green btn-flat\">\n      Update\n    </a>");
  var instance = materialize_css__WEBPACK_IMPORTED_MODULE_1___default.a.Modal.getInstance(document.getElementById('update_produce_modal'));
  instance.open();
}
...
function populate_table_produce() {
  Object(_misc__WEBPACK_IMPORTED_MODULE_0__["getJSON"])('./produces', function (data) {
    for (var i = 0; i <= data.length - 1; i++) {
      document.getElementById('produces_table').innerHTML += "\n      <tr>\n        <td>".concat(data[i].name, "</td>\n        <td>").concat(data[i].duration, "</td>\n        <td>").concat(data[i].image, "</td>\n        <td>\n          <a onclick='delete_produce_modal(").concat(data[i].id, ")' class=\"waves-effect waves-teal btn-flat\">\n            <i class=\"material-icons\">delete</i>\n          </a>\n          <a onclick='update_produce_modal(").concat(data[i].id, ")' class=\"waves-effect waves-teal btn-flat\">\n            <i class=\"material-icons\">edit</i>\n          </a>\n        </td>\n      </tr>");
    }
  }, function (status) {
    alert('Something went wrong.');
  });
...
function add_produce() {
  if (!RegExp('^(?!\\s*$).+').test(document.forms['add_produce']['name'].value)) {
    ...
    post_produce(document.forms['add_produce']['name'].value, document.forms['add_produce']['duration'].value, document.forms['add_produce']['image'].value);
    materialize_css__WEBPACK_IMPORTED_MODULE_1___default.a.toast({
      html: 'Produce Added!'
    });
  }
...
function update_produce(id) {
  if (!RegExp('^(?!\\s*$).+').test(document.forms['update_produce']['name'].value)) {
    ...
    patch_produce(id, document.forms['update_produce']['name'].value, document.forms['update_produce']['duration'].value, document.forms['update_produce']['image'].value);
    materialize_css__WEBPACK_IMPORTED_MODULE_1___default.a.toast({
      html: 'Produce Updated!'
    });
  }
}
...
/***/ "./app/javascript/packs/dashboard-pack.js":
/*!************************************************!*\
  !*** ./app/javascript/packs/dashboard-pack.js ***!
  \************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _dashboard__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../dashboard */ "./app/javascript/dashboard.js");
/* harmony import */ var materialize_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! materialize-css */ "./node_modules/materialize-css/dist/js/materialize.js");
/* harmony import */ var materialize_css__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(materialize_css__WEBPACK_IMPORTED_MODULE_1__);
...
window.addEventListener('load', function () {
  ...
  Object(_dashboard__WEBPACK_IMPORTED_MODULE_0__["populate_table_garden"])();
  Object(_dashboard__WEBPACK_IMPORTED_MODULE_0__["populate_table_produce"])();
}); // Add functions called by html to global scope

window.add_garden = _dashboard__WEBPACK_IMPORTED_MODULE_0__["add_garden"];
window.add_garden_modal = _dashboard__WEBPACK_IMPORTED_MODULE_0__["add_garden_modal"];
window.add_garden_modal_close = _dashboard__WEBPACK_IMPORTED_MODULE_0__["add_garden_modal_close"];
window.add_produce = _dashboard__WEBPACK_IMPORTED_MODULE_0__["add_produce"];
window.add_produce_modal = _dashboard__WEBPACK_IMPORTED_MODULE_0__["add_produce_modal"];
window.add_produce_modal_close = _dashboard__WEBPACK_IMPORTED_MODULE_0__["add_produce_modal_close"];
window.update_garden_modal_close = _dashboard__WEBPACK_IMPORTED_MODULE_0__["update_garden_modal_close"];
window.update_produce_modal_close = _dashboard__WEBPACK_IMPORTED_MODULE_0__["update_produce_modal_close"];
...
/******/ });
//# sourceMappingURL=dashboard-pack-e417a113730fe2bbd50f.js.map