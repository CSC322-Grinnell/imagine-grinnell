...
RSpec.describe VolunteersController, type: :controller do
  ...
  describe 'GET #show' do
    it 'returns a success response' do
      ...
      get :show, params: { id: volunteer.to_param }, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe 'GET #edit' do
    it 'returns a success response' do
      volunteer = Volunteer.create! valid_attributes
      get :edit, params: { id: volunteer.to_param }, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe 'POST #create' do
    context 'with valid params' do
      it 'creates a new Volunteer' do
        expect do
          post :create, params: { volunteer: valid_attributes }, session: valid_session
    ...
    context 'with invalid params' do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: { volunteer: invalid_attributes }, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      ...
      it 'updates the requested volunteer' do
        volunteer = Volunteer.create! valid_attributes
        put :update, params: { id: volunteer.to_param, volunteer: new_attributes }, session: valid_session
        volunteer.reload
      ...
      it 'redirects to the volunteer' do
        volunteer = Volunteer.create! valid_attributes
        put :update, params: { id: volunteer.to_param, volunteer: valid_attributes }, session: valid_session
    ...
    context 'with invalid params' do
      it "returns a success response (i.e. to display the 'edit' template)" do
        volunteer = Volunteer.create! valid_attributes
        put :update, params: { id: volunteer.to_param, volunteer: invalid_attributes }, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe 'DELETE #destroy' do
    it 'destroys the requested volunteer' do
      volunteer = Volunteer.create! valid_attributes
      expect do
        delete :destroy, params: { id: volunteer.to_param }, session: valid_session
      end.to change(Volunteer, :count).by(-1)
    end
